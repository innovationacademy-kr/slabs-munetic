...
import {
  ITutorInfoType,
  ITutorInfoInsertType,
} from '../types/controller/tutorInfoData';
...
export function toTutorInfoType(tutorInfo: TutorInfo): ITutorInfoType {
  return {
    ...
    tutor_introduction: tutorInfo.tutor_introduction,
  };
}
 ...
 * @author joohongpark
 */
export function toTutorInfoEntity(
  user_id: number,
  tutorInfoType: ITutorInfoType,
): ITutorInfoInsertType {
  return {
    user_id,
    ...
    tutor_introduction: tutorInfoType.soundcloud || '',
  };
}
